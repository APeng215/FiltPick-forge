...
public class ContainerScrollBar extends ScrollBar {
     ...
     * @param actualRowNum
     */
    public ContainerScrollBar(int pX, int pY, int scrollSlotHeight, int displayedRowNum, int actualRowNum) {
     ...
     */
    public ContainerScrollBar(int pX, int pY, int scrollSlotHeight, int displayedRowNum, int actualRowNum, boolean active) {
